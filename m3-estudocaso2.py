...
col3.metric(label='Estado com mais Comunidades', value=df['NM_UF'].value_counts().sort_values(ascending=False).index[0], delta=df['NM_UF'].value_counts().sort_values(ascending=False).values[0])
